        ...
        <div className="doador-container">
            <div className="content">
                ...
                <form onSubmit={handleDoador}>
                    ...
                    <input className="idade" type="text" //talvez esse number não seja totalmente aceito e normatizado nos navegadores, além de permitir o caracter “e” entre os números. Ao usar “number” você pode ter problemas ao selecionar o valor via jQuery com: jQuery( ‘.input_type_number’ ).val(); .
