            ...
            <div className="content">
                ...
                <form onSubmit={handleCadastroFunc}>
                    ...
                    <input
                        ...
                        value={email}
                        onChange={e => setEmail(e.target.value)} required //e.target.value representa o valor do input -> colocando dentro da variavel name q to colocando dentro do estado
                    />
