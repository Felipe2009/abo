        ...
        <div className="doador-container">
            <div className="content">
                ...
                <form onSubmit={handleCadastroHistorico}>
                    ...
                    <br></br>
                    <select className="condicao" value={condicao} onChange={e => setCondicao(e.target.value)}
                        style={{ width: 300 }}>
                    ...
                    />
                    <select className="ffmm" value={sexo} onChange={e => setSexo(e.target.value)} required
                        style={{ width: 80 }}>
