        ...
        <div className="doador-container">
            <div className="content">
                <section>
                    ...
                    <h1 classname="hist">Cadastrar Historico</h1>
                    <br></br>
                    <Link className="back-link" to="/historicodoacao">

                        Verificar Histórico
                        <Link className="atualizar" to="/estoque">
                ...
                <form onSubmit={handleCadastroHistorico}>
                    ...
                    <br></br>
                    <select className="condicao" value={condicao} onChange={e => setCondicao(e.target.value)}required
                        style={{ width: 300 }}>
                        <option value="" disabled selected>Doador ou Receptor</option>
