        ...
        <div className="estoque-container">
            ...
            <ul>
                <li>
                    ...
                    <img className="figuraab" src={figuraab}></img>
            ...
            <ul>
                <li>
                    ...
                    <img className="figuraabab" src={figuraabab}></img>
            ...
            <ul>
                <li>
                    ...
                    <img className="figuraabab" src={figuraa}></img>
            ...
            <ul>
                <li>
                    ...
                    <img className="figuraabab" src={figuraaa}></img>
