    ...
    return (
        <div className="estoque-container">
            <header>
                ...
                <Link className="aaaaa" to="/cadastroHistorico">Cadastrar Doação</Link>
                <Link className="voltaagendar" to="/agendar"> Agendar Doação</Link>
            </header>
            <Link className="listagema" to="/lista">Lista de doadores</Link>
