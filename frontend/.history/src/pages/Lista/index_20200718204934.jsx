...
export default function Lista() {
    ...
    this.editDoador = (index, valor) => {
        const editarDoador = this.state.editarDoador.slice();
        editarDoador[index] = valor;
        this.setState({ editarDoador });
    }
    ...
    class ListaViewItem extends React.Component {
        constructor(props) {
            ...
            this.removeDados = () => {
                this.props.removeDados(this.props.index)
            }
            this.editDoador = () => {
                this.props.editDoador(this.props.index, this.state.texto)
                ...
                <table id="tabela" border="6" className="tabelalista">
                    ...
                    <tbody>
                        {doadores.map(doador => (<tr key={doador.cpf}>
                            ...
                            <FiEdit onClick={() => this.abrirForm(doador.cpf)} type="button" className="editar"></FiEdit>
