...
export default function Lista() {
    ...
    const {term,doador} = this.setState;
    ...
    return (
        <div className="lista-container" >
            ...
            <br></br>
            <form>
                <input className="filtro" type="text" onChange={this.searchHandler} value={term}></input>
            </form>
            <table id="tabela" border="6" className="tabelalista">
                ...
                <tbody>
                    {doadores.filter(Searching(term)).map(doador => (<tr key={doador.cpf}>
                        <td> <Editable
                            name="username"
                            dataType="text"
